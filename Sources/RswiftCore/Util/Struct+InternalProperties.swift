...
extension Struct {
  func addingInternalProperties(forBundleIdentifier bundleIdentifier: String, isSwiftPackage: Bool, hostingBundle: String? = nil) -> Struct {
    let hostingBundleValue: String
    if isSwiftPackage {
      hostingBundleValue = "Bundle.module"
    } else {
